...
<head>
  <meta charset="UTF-8">
  <title>My profile | Ethio Connect</title>
  ...
  if (isset($_POST["submit"]) && !empty($_FILES["file"]["name"])) {
    ...
    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
      $sql_update_co_pic = "UPDATE users SET cover_pic = '$fileName' WHERE user_id = '$user_id'";
  ...
  if (isset($_POST["submit2"]) && !empty($_FILES["file2"]["name"])) {
    ...
    if (move_uploaded_file($_FILES["file2"]["tmp_name"], $targetFilePath)) {
      $sql_update_co_pic = "UPDATE users SET profile_pic = '$fileName' WHERE user_id = '$user_id'";
      mysqli_query($db, $sql_update_co_pic);
      echo '<script type="text/javascript">';
      echo "window.location.href = 'my_profile_feed.php';";
      echo "</script>";
  ...
  <section class="cover-sec">
    <img src="users_Img/cover-pic/<?php echo $copp; ?>" alt="">
              ...
              <div class="main-left-sidebar">
                <div class="user_profile">
                  <div class="user-pro-img">
                    ...
                    <img src="users_Img/users_pp/<?php echo $pp; ?>" style="width: 200px;">
                  ...
                  <div class="user_pro_status">
                    <ul class="flw-status">
                      <li>
                        <a href="following_&_followers.php?request=following"><span>Following</span>
                          <?php
                      ...
                      <li>
                        <a href="following_&_followers.php?request=followers"><span>Followers</span>
                          <b><?php echo $followers; ?></b></a>
                      </li>
                    </ul>
                  </div>
                  <ul class="social_links">
                    ...
                    if ($phone_no != "unset") {
                    ?>
                      <li><a href="tel:<?php echo $phone_no; ?>" title="" target="_blank"><i class="fa fa-phone"></i><?php echo $phone_no; ?></a></li>
                    <?php
                    }
                    if ($website != "http://unset") {
                    ?>
                      <li><a href="<?php echo $website; ?>" title="" target="_blank"><i class="la la-globe"></i><?php echo $website; ?></a></li>
                    <?php
                    }
                    if ($facebook != "http://unset") {
                    ?>
                      <li><a href="<?php echo $facebook; ?>" title="" target="_blank"><i class="fa fa-facebook-square"></i> <?php echo $facebook; ?></a></li>
                    <?php
                    }
                    if ($instagram != "http://unset") {
                    ?>
                      <li><a href="<?php echo $instagram; ?>" title="" target="_blank"><i class="fa fa-instagram"></i> <?php echo $instagram; ?></a></li>
                    <?php
                    }
                    if ($twitter != "http://unset") {
                    ?>
                      <li><a href="<?php echo $twitter; ?>" title="" target="_blank"><i class="fa fa-twitter"></i> <?php echo $twitter; ?></a></li>
                    <?php
                    }
                    if ($mail != "unset@unset") {
                    ?>
                      <li><a href="mailto:<?php echo $mail; ?>" title="" target="_blank"><i class="fa fa-envelope"></i> <?php echo $mail; ?></a></li>
                    <?php
                    }
              ...
              <div class="main-ws-sec">
                ...
                <div class="product-feed-tab current" id="feed-dd">
                  ...
                  <div class="posts-section">
                    <?php
                    $sqlposts = "SELECT * FROM post WHERE user_id = '$user_id' order by post_id desc";
            ...
            <div class="col-lg-3">
              <div class="right-sidebar">
                <div class="message-btn">
                  <a href="profile_account_setting.php" title=""><i class="fas fa-cog"></i> Setting</a>
                </div>
